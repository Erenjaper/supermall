<template>
  <div>
    <tabbar>
      ...
      <tabbar-item path="/shopcart" activesColor="deeppink">
      ...
      <tabbar-item path="/profile" activesColor="deeppink">
